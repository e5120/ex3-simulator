...
#define S			(cpu->_S)
#define PC			(cpu->_PC)
#define MEM			(cpu->mem->GetWord(cpu->mem->Address())->value)
...
#define TMRF            (((EX3_CPU *) cpu)->_TMRF)
#define TIMER           (((EX3_CPU *) cpu)->_TIMER)
#define TF              (((EX3_CPU *) cpu)->_TF)

INSN(AND, 0x0000, 0, AC &= MEM;)        // insnID = 7
...
INSN(CLA, 0x7800, 0, AC = 0;)       // instID = 14
...
INSN(INP, 0xf800, 0, AC = (AC & ~0xff) | (INPR & 0xff);	SetFGI(0); INPUT_PENDING = 0;) //instID = 26
